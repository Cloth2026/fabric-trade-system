    ...
    for (const postProcess of data.postProcesses) {
      await tx.postProcess.create({
        data: {
          ...
          unitPriceExclTax: postProcess.unitPriceExclTax,
          unitPriceInclTax: postProcess.unitPriceInclTax,
          taxRate: postProcess.taxRate,
      ...
      if (supplier.initialQuote) {
        ...
        await tx.fabricSupplierQuote.create({
          data: {
            ...
            purchasePriceExclTax: supplier.initialQuote.purchasePriceExclTax,
            purchasePriceInclTax: supplier.initialQuote.purchasePriceInclTax,
            purchaseTaxRate: supplier.initialQuote.purchaseTaxRate,
